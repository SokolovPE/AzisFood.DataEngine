...
public interface ICachedBaseRepository<TEntity> : IBaseRepository<TEntity>
{
    ...
    public Task<IEnumerable<TEntity>> GetHashAsync(bool track = false, CancellationToken token = default);
    ...
    public Task<TEntity> GetHashAsync(Guid id, bool track = false, CancellationToken token = default);
