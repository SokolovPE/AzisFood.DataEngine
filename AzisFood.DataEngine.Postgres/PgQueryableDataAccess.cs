...
/// <inheritdoc />
public class PgQueryableDataAccess : IQueryableDataAccess
{
    // private readonly Dictionary<Type, DbContext> _entityContexts;
    private readonly IServiceProvider _serviceProvider;
    public PgQueryableDataAccess(IServiceProvider serviceProvider)
    {
    ...
    /// <inheritdoc />
    public IQueryable<TRepoEntity> GetAll<TRepoEntity>()
    ...
    /// <inheritdoc />
    public IQueryable<TRepoEntity> Get<TRepoEntity>(Expression<Func<TRepoEntity, bool>> filter)
        where TRepoEntity : class, IRepoEntity
    {
    ...
    {
        var entities = await Get(filter).ToListAsync(token);
